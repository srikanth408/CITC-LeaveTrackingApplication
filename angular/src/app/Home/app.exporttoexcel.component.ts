...
@Component({
  ...
  template : '<a style="margin-top: -6px" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-download-alt" aria-hidden="true"></i> Export</a>'
})
export class ExporttoexcelComponent {
  ...
  downloadExcel(): void {
    FileSaver.saveAs(new Blob([this.s2ab(this.generateExcelFile())], { type: "application/octet-stream" }), "CITC-Employee's.xlsx");
  }
